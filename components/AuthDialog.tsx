        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className={cn(
              ...
              username.trim() ? "bg-primary/20 text-primary" : "bg-muted text-muted-foreground"
            )}>
          ...
          {authMethod === 'key' && (
            <div className="space-y-2">
              ...
              {keys.length === 0 ? (
                ...
                <div className="space-y-2">
                  {keys.filter(k => k.category === 'key').slice(0, 5).map((key) => (
                    <button
                      key={key.id}
                      className={cn(
                            ...
                            {keys.filter(k => k.category === 'key').map((key) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  selectedKeyId === key.id ? "bg-primary/10" : "hover:bg-secondary"
                                )}
                                onClick={() => {
                              ...
                              >
                                ...
                                <span className="text-xs text-muted-foreground ml-auto">{key.type}</span>
                              </button>
                            ))}
                          </div>
                        </ScrollArea>
